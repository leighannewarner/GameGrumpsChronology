...
class PlaylistOperationsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        patch.object(database_mutations, 'update_playlist_order').start()
    ...
    def test_process_uploads_dry_run(self):
        ...
        youtube_reads.list_videos_in_playlist.return_value = self.video_response()
        ...
        self.assertEqual(youtube_reads.list_videos_in_playlist.call_count, 3)
        ...
        database_mutations.update_playlist_order.assert_not_called()
    ...
    def test_process_uploads_filters_processed(self):
        ...
        self.assertEqual(database_mutations.update_playlist_order.call_count, 1)
    ...
    def test_process_uploads_insert_existing_playlists(self):
        ...
        database_reads.get_existing_playlist_row.side_effect = ['pl1', None]
        youtube_reads.list_videos_in_playlist.side_effect = [[], [], []]
    ...
    def test_set_playlist_order(self):
        ...
        self.assertEqual(database_mutations.insert_videos.call_count, 1)
        self.assertEqual(database_mutations.update_playlist_order.call_count, 1)
        database_mutations.update_playlist_order.assert_called_with(
            [{'video_id': 'abc123', 'date': '2012-06-20T22:45:24.000Z',
              'playlist_order': '2012-06-20T22:45:24.000Z~0000'},
             {'video_id': 'def456', 'date': '2012-07-20T22:45:24.000Z',
              'playlist_order': '2012-06-20T22:45:24.000Z~0001'},
             {'video_id': 'ghi789', 'date': '2012-08-20T22:45:24.000Z',
